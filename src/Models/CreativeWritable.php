...
class CreativeWritable implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     * @param array $front
     * @param array $back
     * @param Details2 $details
     */
    public function __construct(string $campaignId, array $front, array $back, Details2 $details)
    {
     ...
     * Returns Details.
     */
    public function getDetails(): Details2
    {
        return $this->details;
    }
     ...
     * @maps details
     */
    public function setDetails(Details2 $details): void
    {
        $this->details = $details;
    }
