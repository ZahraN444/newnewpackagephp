...
/**
 * Properties that the letters in your Creative should have. Check within in order to add a QR code to
 * your creative.
 */
class LetterDetailsWritable implements \JsonSerializable
{
    /**
     * @var string|null
     */
