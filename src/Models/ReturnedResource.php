...
class ReturnedResource implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * @param Details5 $details
     */
    public function __construct(Details5 $details)
    {
     ...
     * Returns Details.
     */
    public function getDetails(): Details5
    {
        return $this->details;
    }
     ...
     * @maps details
     */
    public function setDetails(Details5 $details): void
    {
        $this->details = $details;
    }
