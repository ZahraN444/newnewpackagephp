...
class Registered implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     * @param array $useType
     */
    public function __construct(bool $color, array $to, array $from, string $id, array $useType)
    {
        $this->color = $color;
        $this->to = $to;
        $this->from = $from;
     ...
     * Add an extra service to your letter. See <a href="https://www.lob.com/pricing/print-mail#compare"
