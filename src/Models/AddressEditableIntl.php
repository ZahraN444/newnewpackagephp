...
class AddressEditableIntl implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $addressLine1, string $addressCountry)
    {
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        $json['address_country']   = CountryExtendedEnum::checkValue($this->addressCountry);
