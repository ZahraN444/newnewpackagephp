...
class AllAddresses implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * @var array<AddressUs|AddressIntl>|null
     */
    private $data;
     ...
     * list of addresses
     *
     * @return array<AddressUs|AddressIntl>|null
     */
     ...
     *
     * @maps data
     * @mapsBy anyOf(oneOf(AddressUs,AddressIntl)[],null)
     *
     * @param array<AddressUs|AddressIntl>|null $data
     */
        ...
        if (isset($this->data)) {
            $json['data']         =
                ApiHelper::getJsonHelper()->verifyTypes(
                    $this->data,
                    'anyOf(oneOf(AddressUs,AddressIntl)[],null)'
                );
        }
