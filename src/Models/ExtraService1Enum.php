...
class ExtraService1Enum
{
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ExtraService1Enum.");
    }
}
