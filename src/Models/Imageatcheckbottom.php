...
class Imageatcheckbottom implements \JsonSerializable
{
    /**
     * @var array
     */
     ...
     * @param float $amount
     * @param array $checkBottom
     */
    public function __construct(array $useType, $to, $from, string $bankAccount, float $amount, array $checkBottom)
    {
