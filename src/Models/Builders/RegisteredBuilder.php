...
use LobLib\Models\Registered;

/**
 * Builder for model Registered
 *
 * @see Registered
 */
class RegisteredBuilder
{
    ...
    private function __construct(Registered $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new registered Builder object.
     */
    public static function init(bool $color, array $to, array $from, string $id, array $useType): self
    {
        return new self(new Registered($color, $to, $from, $id, $useType));
    }
    ...
    /**
     * Initializes a new registered object.
     */
    public function build(): Registered
    {
