...
/**
 * Builder for model BuckslipsResponse
 *
 * @see BuckslipsResponse
 */
class BuckslipsResponseBuilder
{
    /**
     * @var BuckslipsResponse
     */
    private $instance;

    private function __construct(BuckslipsResponse $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new buckslips response Builder object.
     */
    public static function init(): self
    {
        return new self(new BuckslipsResponse());
    }
    ...
    /**
     * Initializes a new buckslips response object.
     */
    public function build(): BuckslipsResponse
    {
