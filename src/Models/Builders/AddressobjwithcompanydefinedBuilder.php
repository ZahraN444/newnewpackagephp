...
use LobLib\Models\Addressobjwithcompanydefined;

/**
 * Builder for model Addressobjwithcompanydefined
 *
 * @see Addressobjwithcompanydefined
 */
class AddressobjwithcompanydefinedBuilder
{
    /**
     * @var Addressobjwithcompanydefined
     */
    private $instance;

    private function __construct(Addressobjwithcompanydefined $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new addressobjwithcompanydefined Builder object.
     */
    public static function init(): self
    {
        return new self(new Addressobjwithcompanydefined());
    }
    ...
    /**
     * Initializes a new addressobjwithcompanydefined object.
     */
    public function build(): Addressobjwithcompanydefined
    {
