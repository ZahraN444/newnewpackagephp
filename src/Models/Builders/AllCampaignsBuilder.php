...
/**
 * Builder for model AllCampaigns
 *
 * @see AllCampaigns
 */
class AllCampaignsBuilder
{
    /**
     * @var AllCampaigns
     */
    ...
    private function __construct(AllCampaigns $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new all campaigns Builder object.
     */
    public static function init(): self
    {
        return new self(new AllCampaigns());
    }
    ...
    /**
     * Initializes a new all campaigns object.
     */
    public function build(): AllCampaigns
    {
