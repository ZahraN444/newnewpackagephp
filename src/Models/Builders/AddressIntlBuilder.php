...
/**
 * Builder for model AddressIntl
 *
 * @see AddressIntl
 */
class AddressIntlBuilder
{
    /**
     * @var AddressIntl
     */
    ...
    private function __construct(AddressIntl $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new address intl Builder object.
     */
    public static function init(
        ...
        return new self(new AddressIntl($dateCreated, $dateModified, $id, $addressLine1, $addressCountry));
    }
    ...
    /**
     * Initializes a new address intl object.
     */
    public function build(): AddressIntl
    {
