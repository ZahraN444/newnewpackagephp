...
use LobLib\Models\Certified;

/**
 * Builder for model Certified
 *
 * @see Certified
 */
class CertifiedBuilder
{
    ...
    private function __construct(Certified $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new certified Builder object.
     */
    public static function init(
        ...
        return new self(new Certified($extraService, $trackingEvents, $color, $to, $from, $id, $useType));
    }
    ...
    /**
     * Initializes a new certified object.
     */
    public function build(): Certified
    {
