...
/**
 * Builder for model CardsResponse
 *
 * @see CardsResponse
 */
class CardsResponseBuilder
{
    /**
     * @var CardsResponse
     */
    ...
    private function __construct(CardsResponse $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new cards response Builder object.
     */
    public static function init(): self
    {
        return new self(new CardsResponse());
    }
    ...
    /**
     * Initializes a new cards response object.
     */
    public function build(): CardsResponse
    {
