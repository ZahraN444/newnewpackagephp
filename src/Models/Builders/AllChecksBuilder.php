...
/**
 * Builder for model AllChecks
 *
 * @see AllChecks
 */
class AllChecksBuilder
{
    /**
     * @var AllChecks
     */
    ...
    private function __construct(AllChecks $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new all checks Builder object.
     */
    public static function init(): self
    {
        return new self(new AllChecks());
    }
    ...
    /**
     * Initializes a new all checks object.
     */
    public function build(): AllChecks
    {
