...
/**
 * Builder for model BuckslipsOrdersResponse
 *
 * @see BuckslipsOrdersResponse
 */
class BuckslipsOrdersResponseBuilder
{
    /**
     * @var BuckslipsOrdersResponse
     */
    private $instance;

    private function __construct(BuckslipsOrdersResponse $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new buckslips orders response Builder object.
     */
    public static function init(): self
    {
        return new self(new BuckslipsOrdersResponse());
    }
    ...
    /**
     * Initializes a new buckslips orders response object.
     */
    public function build(): BuckslipsOrdersResponse
    {
