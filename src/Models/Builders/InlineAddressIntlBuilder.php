...
use LobLib\Models\InlineAddressIntl;

/**
 * Builder for model InlineAddressIntl
 *
 * @see InlineAddressIntl
 */
class InlineAddressIntlBuilder
{
    /**
     * @var InlineAddressIntl
     */
    private $instance;

    private function __construct(InlineAddressIntl $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new inline address intl Builder object.
     */
    public static function init(string $addressLine1, string $addressCountry): self
    {
        return new self(new InlineAddressIntl($addressLine1, $addressCountry));
    }
    ...
    /**
     * Initializes a new inline address intl object.
     */
    public function build(): InlineAddressIntl
    {
