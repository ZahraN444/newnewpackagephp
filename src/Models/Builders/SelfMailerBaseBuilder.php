...
use LobLib\Models\SelfMailerBase;

/**
 * Builder for model SelfMailerBase
 *
 * @see SelfMailerBase
 */
class SelfMailerBaseBuilder
{
    /**
     * @var SelfMailerBase
     */
    ...
    private function __construct(SelfMailerBase $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new self mailer base Builder object.
     */
    public static function init(): self
    {
        return new self(new SelfMailerBase());
    }
    ...
    /**
     * Initializes a new self mailer base object.
     */
    public function build(): SelfMailerBase
    {
