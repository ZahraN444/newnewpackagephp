...
| `message` | `string` | Required | Max of 400 characters to be included at the bottom of the check page.<br>**Constraints**: *Maximum Length*: `400` | getMessage(): string | setMessage(string message): void |
...
| `checkBottom` | [`?array`](../../doc/models/object-enum.md) | Optional | - | getCheckBottom(): ?array | setCheckBottom(?array checkBottom): void |
