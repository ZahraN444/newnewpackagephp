...
| `inside` | string | Required | This is a container for one-of cases. | getInside(): string | setInside(string inside): void |
| `outside` | string | Required | This is a container for one-of cases. | getOutside(): string | setOutside(string outside): void |
