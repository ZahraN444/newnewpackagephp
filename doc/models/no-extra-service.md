...
|  --- | --- | --- | --- | --- | --- |
| `trackingEvents` | [`?(TrackingEventNormal[])`](../../doc/models/tracking-event-normal.md) | Optional | An array of tracking events ordered by ascending `time`. | getTrackingEvents(): ?array | setTrackingEvents(?array trackingEvents): void |
| `cards` | [`?(Card[])`](../../doc/models/card.md) | Optional | An array of cards associated with a specific letter | getCards(): ?array | setCards(?array cards): void |
| `buckslips` | [`?(Buckslip[])`](../../doc/models/buckslip.md) | Optional | An array of buckslip(s) associated with a specific letter | getBuckslips(): ?array | setBuckslips(?array buckslips): void |
